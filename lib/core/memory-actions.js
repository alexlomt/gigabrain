...
const writeNativeForAction = ({
  ...
  return {
    ...
    counters: {
      ...
      native_source_paths: result?.written && result.source_path ? [String(result.source_path)] : [],
    },
  };
};
...
const applyMemoryActions = ({
  ...
  for (const action of relevantActions) {
    ...
    if (Array.isArray(result.native_source_paths)) {
      summary.native_source_paths.push(...result.native_source_paths);
    }
